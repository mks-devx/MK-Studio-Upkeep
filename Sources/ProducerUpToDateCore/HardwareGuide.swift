...
public struct HardwareVendorGuide: Hashable, Sendable {
    ...
    static let entries: [(names: [String], prefixes: [String], guide: HardwareVendorGuide)] = [
        ...
        (["universal audio", "universal audio inc."], ["com.uaudio."],
         .init(vendor: "Universal Audio", updateRoute: "UA Connect", url: URL(string: "https://www.uaudio.com/pages/downloads"), managerBundleIdentifier: nil, note: nil)),
        ...
        (["audient"], ["com.audient."],
         .init(vendor: "Audient", updateRoute: "Audient downloads page", url: URL(string: "https://support.audient.com/hc/en-us/sections/12662721948180-Downloads"), managerBundleIdentifier: nil, note: nil)),
        (["solid state logic", "ssl"], ["com.solidstatelogic."],
         .init(vendor: "Solid State Logic", updateRoute: "SSL 360 and the support page", url: URL(string: "https://support.solidstatelogic.com/hc/en-gb/articles/4408123894417-SSL-360-Downloads-and-Release-Notes"), managerBundleIdentifier: nil, note: nil)),
        ...
        (["behringer", "music tribe"], ["com.behringer.", "com.musictribe."],
         .init(vendor: "Behringer", updateRoute: "Behringer product page", url: URL(string: "https://www.behringer.com/en/products"), managerBundleIdentifier: nil,
               note: "Choose the exact product, then open its Downloads section.")),
        ...
        (["softube", "softube ab"], ["com.softube.", "org.softube."],
         .init(vendor: "Softube", updateRoute: "Softube Central", url: URL(string: "https://www.softube.com/us/support"), managerBundleIdentifier: nil,
               note: "Softube Central and direct installers are available through Softube support and your account.")),
