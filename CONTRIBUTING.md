...
Contributions are submitted under [AGPL-3.0](LICENSE).
...
under AGPL-3.0. Preserve existing notices, disclose third-party material and its
...
pricing. Reuse and distribution must follow AGPL-3.0 and applicable third-party
terms. See [reuse boundaries](docs/ARCHITECTURE.md).
